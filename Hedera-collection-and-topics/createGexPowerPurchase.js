...
async function main() {
  ...
  try {
    ...
    console.log("🖼️  CREATING GEX POWER PURCHASE AGREEMENT COLLECTION...");
    let txCreate = new TokenCreateTransaction()
      .setTokenName("GEX Power Purchase Agreement")
      .setTokenSymbol("GEX-PPA")
      .setTokenType(TokenType.NonFungibleUnique)
      .setTreasuryAccountId(MY_ACCOUNT_ID)
      .setSupplyKey(MY_PRIVATE_KEY)
      .setDecimals(0)
      .setMaxTransactionFee(new Hbar(10)); // Increased fee to avoid INSUFFICIENT_TX_FEE
