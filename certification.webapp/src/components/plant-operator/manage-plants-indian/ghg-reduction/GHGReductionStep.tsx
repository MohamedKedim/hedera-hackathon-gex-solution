...
const GHGReductionStep: React.FC<Props> = ({ data, onChange }) => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-md font-semibold text-gray-800 mb-4">GHG Reduction</h3>
      <div className='bg-white shadow rounded-lg p-6 mb-4'>
      {/* Methodologies */}
      <SelectWithCheckboxTags
        label="Your Green House Gas emissions  include"
        options={[
          'Carbon Dioxide CO2',
          'Methane CH4',
          'Nitrou Oxide N2O',
      ...
      <h3 className="text-md font-semibold text-gray-800 mb-4">Carbon Footprint</h3>
      <div className='bg-white shadow rounded-lg p-6 mb-4'>

        {/* metodologies */}
      <SelectWithCheckboxTags
        label="What are the metodologies you use for calculating and reporting your carbon footprint ?(select all that apply)"
        options={[
          'GHG Protocol',
          'ISO 14064',
          'ISO 14067',
