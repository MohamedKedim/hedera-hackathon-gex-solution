...
import HydrogenFields from '@/components/plant-operator/manage-plants-indian/general-info/HydrogenFields';
import AmmoniaFields from '@/components/plant-operator/manage-plants-indian/general-info/AmmoniaFields';
import ENGFields from '@/components/plant-operator/manage-plants-indian/general-info/ENGFields';
import SAFFields from '@/components/plant-operator/manage-plants-indian/general-info/SAFFields';
import BiofuelFields from '@/components/plant-operator/manage-plants-indian/general-info/BiofuelFields';
import MethanolFields from '@/components/plant-operator/manage-plants-indian/general-info/MethanolFields';
...
import OffTakersStep from '@/components/plant-operator/manage-plants-indian/off-takers/OffTakersStep';
...
import GeneralInformations from '@/components/plant-operator/manage-plants-indian/general-info/GeneralInformations';
...
interface WaterData {
  ...
  treatmentLocation: { [source: string]: string[] };  // ✅ correct
  monitoringFile?: File | null; // ✅ optional
}
    ...
    <form className="w-full p-8 min-h-screen" autoComplete="off">
      ...
      <FacilityDropdown
        ...
        onChange={(e) => {
          ...
          router.push(`/plant-operator/manage-plants-indian?selected=${newId}`);
        }}
      />
      ...
      <div className="flex justify-between items-center pb-4 mb-8 relative">
        <div className="absolute top-[5px] left-[4%] right-[3%] h-[1px] bg-gray-400 z-0"></div>
