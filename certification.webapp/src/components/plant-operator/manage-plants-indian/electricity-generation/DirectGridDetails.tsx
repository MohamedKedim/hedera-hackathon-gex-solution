  ...
  return (
    <div className="ml-4 flex flex-col gap-4 mt-2">
      ...
      <div className="flex items-center gap-6 mb-1">
        <label className="block mb-1 text-sm font-medium whitespace-nowrap">Do you have GoO?</label>
      ...
      <div className="flex items-center gap-6 mt-4">
        <label className="fblock mb-1 text-sm font-medium whitespace-nowrap">Can you share your utility invoices?</label>
        <div className="flex gap-4">
          <label className="flex items-center gap-1">
            <input
              type="radio"
